...
public class Copy_2_of_MainSurfaceView extends SurfaceView implements SurfaceHolder.Callback, Runnable {
	
	DemoRenderer mRenderer;
	 SurfaceHolder mSurfaceHolder;
    public Copy_2_of_MainSurfaceView(Context context, AttributeSet set) {
        super(context, set);
