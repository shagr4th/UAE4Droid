     ...
     struct fs_usage *fsp;
{
    ...
    if (!GetDiskFreeSpaceEx ("\\", NULL, &TotalNumberOfBytes, &FreeBytesAvailable))
    {
	/* lasterror = GetLastError ();*/
	return -1;
    }
    
    fsp->fsu_blocks = TotalNumberOfBytes / 512;
    fsp->fsu_bavail = FreeBytesAvailable / 512;
    
    return 0;
}

#elif defined (_WIN32) && !defined(__WINS__) /* ! ARM_WINCE */
#include "sysdeps.h"
#include <windows.h>
int
get_fs_usage (path, disk, fsp)
