...
char *text_str_memdisk_separator="---------------------------------*----";
static char *text_str_memdisk_title=    "     Memory and Disk Options     -";
char *text_str_off="off";
char *text_str_on="on";
char *text_str_512K="512K";
char *text_str_1M="1M";
char *text_str_1_5M="1.5M";
char *text_str_2M="2M";
char *text_str_4M="4M";
char *text_str_8M="8M";
...
static void draw_memDiskMenu(int c)
{
	...
	if ((mainMenu_slowMemory==0)&&((c!=2)||(!bb)))
		write_text_inv(tabstop3,menuLine,text_str_off);
	else
		write_text(tabstop3,menuLine,text_str_off);
	
	if ((mainMenu_slowMemory==1)&&((c!=2)||(!bb)))
		write_text_inv(tabstop3 + 4,menuLine,text_str_512K);
	else
		write_text(tabstop3 + 4,menuLine,text_str_512K);
	
	if ((mainMenu_slowMemory==2)&&((c!=2)||(!bb)))
		write_text_inv(tabstop3 + 9,menuLine,text_str_1M);
	else
		write_text(tabstop3 + 9,menuLine,text_str_1M);

	if ((mainMenu_slowMemory==3)&&((c!=2)||(!bb)))
	...
	if ((mainMenu_fastMemory==0)&&((c!=3)||(!bb)))
		write_text_inv(tabstop3,menuLine,text_str_off);
	else
		write_text(tabstop3,menuLine,text_str_off);

	if ((mainMenu_fastMemory==1)&&((c!=3)||(!bb)))
		write_text_inv(tabstop3 + 9,menuLine,text_str_1M);
	else
		write_text(tabstop3 + 9,menuLine,text_str_1M);
	
	if ((mainMenu_fastMemory==2)&&((c!=3)||(!bb)))
		write_text_inv(tabstop3 + 12,menuLine,text_str_2M);
	else
		write_text(tabstop3 + 12,menuLine,text_str_2M);

	if ((mainMenu_fastMemory==3)&&((c!=3)||(!bb)))
		write_text_inv(tabstop3 + 15,menuLine,text_str_4M);
	else
		write_text(tabstop3 + 15,menuLine,text_str_4M);

	if ((mainMenu_fastMemory==4)&&((c!=3)||(!bb)))
		write_text_inv(tabstop3 + 18,menuLine,text_str_8M);
	else
		write_text(tabstop3 + 18,menuLine,text_str_8M);
	...
	if ((mainMenu_bootHD==0)&&((c!=4)||(!bb)))
		write_text_inv(tabstop3,menuLine,text_str_off);
	else
		write_text(tabstop3,menuLine,text_str_off);

	if ((mainMenu_bootHD==1)&&((c!=4)||(!bb)))
		write_text_inv(tabstop3 + 7,menuLine,"Dir");
	else
		write_text(tabstop3 + 7,menuLine,"Dir");
	
	if ((mainMenu_bootHD==2)&&((c!=4)||(!bb)))
...
static int key_memDiskMenu(int *c)
{
	...
	{
		if (menuMemDisk==0) menuMemDisk=7;
		else menuMemDisk--;
	}
	else if (down)
	{
		if (menuMemDisk==7) menuMemDisk=0;
		else menuMemDisk++;	
	}
